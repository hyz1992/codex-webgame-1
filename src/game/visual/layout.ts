...
export const MAIN_ROAD_EDGE_LANE_OFFSET = 1.5 + 1 / 3;
export const ROADSIDE_LAMP_LANE_OFFSET = MAIN_ROAD_EDGE_LANE_OFFSET;
export const TRACK_BOTTOM_EDGE_MULTIPLIER = MAIN_ROAD_EDGE_LANE_OFFSET;
